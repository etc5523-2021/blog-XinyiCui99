...
description: |
  This post is about COVID-19 situation in Germany
author:
  - name: Xinyi Cui
date: 08-31-2021
output:
...
The table below are the numeric summary statistics of mean, maximum and standard deviation for **new_cases**, **new_deaths**, **daily_recover** and **daily_vaccination**.
...
datatable(numerical, 
          caption= "Statistics summary for new cases and new deaths",
          options = list(pageLength = 4))
```

# Analysis: Trend in the table
...
trend <- Germany %>% 
 ...
 datatable(trend, 
           escape = FALSE,
           caption = "Trend of confirmed cases, deaths, recovery and vaccincation by month in Germany",
            colnames = c("Year","Month", "New Cases", "Confirmed Death", "Daily recovery", "Daily vaccination"),
...
From the graph we can see:
 ...
 FACT:
 By June 2021: 55% German citizen had their first COVID injection, 35% were fully injected. (Bosen, 2021)
